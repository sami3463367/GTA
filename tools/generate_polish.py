...
save(mini,'radar_map')
im=Image.new('RGBA',(40,50));d=ImageDraw.Draw(im)
d.rounded_rectangle((1,2,38,48),3,fill=(187,174,137,255),outline=(41,61,72,255),width=2)
d.rectangle((6,7,33,43),fill=(32,62,82,255));d.rectangle((9,10,30,29),fill=(79,145,161,255));d.line((10,12,27,12),fill=(177,225,217,255),width=2)
d.rectangle((27,33,30,39),fill=(242,210,134,255));d.rectangle((8,2,32,6),fill=(179,228,162,255));save(im,'entrance')
